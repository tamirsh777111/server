...
const createNewCardSchemaSchemaValidation = (userInput) => {
  return createNewCardSchema.validateAsync(userInput);
};

export default createNewCardSchemaSchemaValidation;
